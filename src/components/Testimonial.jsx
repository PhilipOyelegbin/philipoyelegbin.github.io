  ...
  return (
    <section className="bg-gray-700 px-5 py-10 xl:px-10">
        ...
        <div className="flex flex-wrap justify-center gap-5">
            {loading ? <p className="text-2xl text-center">Loading...</p> : error ? error : data.length < 1 ? <p className="text-2xl text-center">No testimonial yet...</p> : data.results && data.results?.map(testimony =>
                (
