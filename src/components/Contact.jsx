        ...
        <div
          ...
          <div className="lg:w-1/2">
            ...
            >
              ...
              <input type={"text"} name={"Full Name"} id="fullname" className="bg-slate-300 text-black mb-2 p-2 rounded-md w-full focus:outline-none" placeholder={"Enter your full name"} required/><br />

              <input type={"email"} name={"Email"} id="email" className="bg-slate-300 text-black mb-2 p-2 rounded-md w-full focus:outline-none" placeholder={"Enter your email address"} required
              /><br />
