  ...
  return (
    <section id="about" className="px-5 py-10 flex flex-col-reverse xl:flex-row xl:justify-between xl:items-center gap-3 lg:px-20">
      <div className="flex flex-col text-justify xl:w-1/2">
        ...
        <p className="mt-3">I've served as a Robotics Instructor, demonstrating leadership and commitment to STEM education. I'm adaptable, collaborative, innovative, and eager to contribute to a dynamic team. I'm focused on providing solutions like:</p>
